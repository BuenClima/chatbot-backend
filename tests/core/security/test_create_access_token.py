...
from app.core.configuration import ACCESS_JWT_SECRET, ALGORITHM
...
def test_create_access_token_with_default_expiry():
    ...
    decoded_token = jwt.decode(token, ACCESS_JWT_SECRET, algorithms=[ALGORITHM])
...
def test_create_access_token_with_custom_expiry():
    ...
    assert (
        datetime.fromtimestamp(decoded_token["exp"], tz=timezone.utc) <= expected_expiry
    )
